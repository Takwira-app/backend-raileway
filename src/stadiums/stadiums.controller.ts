import { Controller, Get, Post, Body, Patch,Put, Param, Delete, Query, ParseIntPipe, UseGuards, Req } from '@nestjs/common';
...
export class StadiumsController {
  ...
  @UseGuards(JwtAuthGuard,RolesGuard)
  @Roles('owner')
  update(@Param('id',ParseIntPipe) id: number,@Body() updateStadiumDto: UpdateStadiumDto,@Req() req) {
  ...
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles('owner')
  updateStatus(@Param('id', ParseIntPipe) id: number,@Body() dto: UpdateStadiumStatusDto,@Req() req) {
